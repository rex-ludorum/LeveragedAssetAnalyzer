...
iterDate = datetime.datetime.strptime("2023-03-18", "%Y-%m-%d").date()

baseUrl = "https://api.polygon.io/v1/open-close/"

tickerList = ["SOXX/", "SOXL/", "SOXS/", "QQQ/", "TQQQ/", "SQQQ/", "FNGS/", "FNGU/", "FNGD/", "SPY/", "SPXL/", "SPXS/", "XLF/", "FAS/",
